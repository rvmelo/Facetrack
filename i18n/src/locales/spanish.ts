export default {
  ...
  loginRegisterError: 'Error de inicio de sesión / registro',

  //  BirthDate
  birthDate: 'Fecha de Nacimiento',
  invalidDateError: 'Fecha Invalida',
  underAgeError: 'Eres menor de edad',
  timeTravelerError: 'Lo más probable es que no seas un viajero en el tiempo',

  //  Gender Screen
  sexSelection: 'Selecciona tu Género',
  male: 'Masculino',
  female: 'Feminino',
  ...
  trackInfoLabel:
    'Encuentra y califica perfiles de Instagram en todo el mundo o cerca de ti',
  randomTrack: 'Buscar usuarios aleatorios',
  trackByDistance: 'Buscar usuarios por distancia',
  ...
  locationPermissionError:
    'Debes permitir que esta aplicación acceda a la localización de tu dispositivo',
