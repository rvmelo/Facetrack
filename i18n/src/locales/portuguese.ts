export default {
  ...
  loginRegisterError: 'Erro de Login/Cadastro',
  ...
  //  Gender Screen
  sexSelection: 'Selecione seu \nSexo',
  male: 'Masculino',
  female: 'Feminino',

  //  Relationship Status Screen
  relationshipStatus: 'Status de \nRelacionamento',
  ...
  userCreationError: 'Falha na criação do usuário',
  ...
  enableNotification: 'Notificações',
  enableNotificationSound: 'Som de notificação',
  ...
  notificationsNotFound: 'Nenhuma notificação encontrada',
  notificationInfo: 'Avalie outros usuários para receber notificações',
  ...
  instagramRefreshFailed: 'Você precisa renovar suas permissões do instagram.',
  instagramLimitExceeded:
    'Você excedeu o limite do número de chamadas ao instagram.',
  yes: 'Sim',
  no: 'Não',

  //  track screen
  trackScreenTitle: 'Selecione uma distância',
  trackScreenInfo: 'Selecione uma distância e encontre usuários ao seu redor',
  ...
  selectMetricUnit: 'Selecione uma escala',
  meters: 'Metros',
